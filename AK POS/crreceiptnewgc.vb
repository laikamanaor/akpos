...
Public Class crreceiptnewgc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AK_POS.crreceiptnewgc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrreceiptnewgc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crreceiptnewgc = New crreceiptnewgc()
        rpt.Site = Me.Site
        Return rpt
    End Function
