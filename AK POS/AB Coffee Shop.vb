...
Public Class AB_Coffee_Shop
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AK_POS.AB Coffee Shop.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAB_Coffee_Shop
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AB_Coffee_Shop = New AB_Coffee_Shop()
        rpt.Site = Me.Site
        Return rpt
    End Function
