...
Public Class reprintgc
    ...
    Public objRpt As New crreceiptnewgccopy
    ...
    Private Sub receiptprev_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If sngle = True Then
                ...
                objRpt.SetDataSource(Me.ds.Tables(10))
                ...
                '// If a = vbYes Then
                'MsgBox(ds.Tables(10).Rows(0).Item(0))
        ...
        Try
            ...
            If disc <> "" Then
                If disc.Contains("Pwd") Or disc.Contains("Senior") Or disc.Contains("Edis") Or disc.Contains("Employee") Then
                    sqlquery = "SELECT tbltransaction.transnum,tbltransaction.cashier,tbltransaction.servicetype,tbltransaction.delcharge,tbltransaction.subtotal,tbltransaction.less,tbltransaction.vat,tbltransaction.amtdue,tbltransaction.tenderamt,tbltransaction.change,tblorder.itemname,tblorder.qty,tblorder.discprice,tblorder.totalprice,tbltransaction.vatsales,tbltransaction.transid,tblorder.dscnt,tblorder.request,tbltransaction.gctotal,tblsenior.idno,tblsenior.name  FROM tbltransaction RIGHT OUTER JOIN tblorder ON tbltransaction.transnum=tblorder.transnum RIGHT OUTER JOIN tblsenior ON tbltransaction.transnum=tblsenior.transnum where tbltransaction.transnum='" & trnum & "' order by tbltransaction.transid DESC"
                Else
                    sqlquery = "SELECT tbltransaction.transnum,tbltransaction.cashier,tbltransaction.servicetype,tbltransaction.delcharge,tbltransaction.subtotal,tbltransaction.less,tbltransaction.vat,tbltransaction.amtdue,tbltransaction.tenderamt,tbltransaction.change,tblorder.itemname,tblorder.qty,tblorder.discprice,tblorder.totalprice,tbltransaction.vatsales,tbltransaction.transid,tblorder.dscnt,tblorder.request,tbltransaction.gctotal FROM tbltransaction RIGHT OUTER JOIN tblorder ON tbltransaction.transnum=tblorder.transnum where tbltransaction.transnum='" & trnum & "' order by tbltransaction.transid DESC"
                End If
                connect()
                sql = procesSQL()
                ...
                dscmd.Fill(ds.DataTable11)
                'MsgBox(ds.Tables(10).Rows.Count)
                disconnect()
            ...
            If ds.Tables(10).Rows.Count > 0 Then
                If ds.Tables(10).Rows(0).Item("DataColumn6") = "0.00" Then
                ...
                If ds.Tables(10).Rows(0).Item("DataColumn16") < 1000000 Then
                    Dim temp As String = ""
                    Dim s As String = ds.Tables(10).Rows(0).Item("DataColumn16")
                    For vv As Integer = 1 To 6 - s.Length
                        temp = temp & "0"
                    Next
                    ds.Tables(10).Rows(0).Item("DataColumn16") = temp & s
                End If
                ...
                connect()
                For i = 0 To ds.Tables(10).Rows.Count - 1
                    ds.Tables(10).Rows(i).Item("DataColumn24") = Val(ds.Tables(10).Rows(i).Item("DataColumn5")) - (Val(ds.Tables(10).Rows(i).Item("DataColumn8")) - Val(ds.Tables(10).Rows(i).Item("DataColumn4")))
                    ...
                    ds.Tables(10).Rows(i).Item("DataColumn25") = tempprice

                    ds.Tables(10).Rows(i).Item("DataColumn23") = Val(ds.Tables(10).Rows(i).Item("DataColumn24")) + Val(ds.Tables(10).Rows(i).Item("DataColumn25"))

                    If ds.Tables(10).Rows(i).Item("DataColumn6") = 100 Then
                        ds.Tables(10).Rows(i).Item("DataColumn23") = 0
                    End If
                    ...
                    If dr.Read Then
                        If dr("disctype").ToString.Contains("Senior") Or dr("disctype").ToString.Contains("Pwd") Then
                            If dr("remarks").ToString.Contains("W/ GRPM") Then
                                ds.Tables(10).Rows(i).Item("DataColumn22") = (dr("vatsales") + dr("vat")) / 1.12
                                ds.Tables(10).Rows(i).Item("DataColumn23") = ds.Tables(10).Rows(i).Item("DataColumn22") * 0.2
                                Dim lessbased As Double = dr("subtotal") - (dr("vatsales") + dr("vat"))
                                ds.Tables(10).Rows(i).Item("DataColumn15") = lessbased / 1.12
                                ds.Tables(10).Rows(i).Item("DataColumn7") = lessbased - (lessbased / 1.12)
                            Else
                                ds.Tables(10).Rows(i).Item("DataColumn22") = Val(ds.Tables(10).Rows(i).Item("DataColumn5") / 1.12).ToString("n2")
                                ds.Tables(10).Rows(i).Item("DataColumn23") = ds.Tables(10).Rows(i).Item("DataColumn22") * 0.2
                                ds.Tables(10).Rows(i).Item("DataColumn15") = "0.00"
                                ds.Tables(10).Rows(i).Item("DataColumn7") = "0.00"
                            End If
                        Else
                            ds.Tables(10).Rows(i).Item("DataColumn22") = "0.00"
                        End If
    ...
    Public Sub multitr()
        Try
            ...
            While dr.Read
                ...
                'If ds.Tables(10).Rows.Count > 0 And rnddisc = False Then
                If ds.Tables(10).Rows.Count > 0 Then
                    If refund = "1" Then
                        MyLine = CType(objRpt.ReportDefinition.ReportObjects("Line2"), LineObject)
                        MyLine.LineStyle = LineStyle.NoLine
                ...
                If ds.Tables(10).Rows.Count > 0 Then
                    ...
                    For i = 0 To ds.Tables(10).Rows.Count - 1
                        If ds.Tables(10).Rows(i).Item("DataColumn17") <> "0" Then
                            ds.Tables(10).Rows(i).Item("DataColumn11") = ds.Tables(10).Rows(i).Item("DataColumn11") & " -" & ds.Tables(10).Rows(i).Item("DataColumn17") & "% off"
                        End If
                    Next
                    ...
                    For i = 0 To ds.Tables(10).Rows.Count - 1
                        ...
                        If dr.Read Then
                            If dr("disctype").ToString.Contains("Senior") Or dr("disctype").ToString.Contains("Pwd") Then
                                ds.Tables(10).Rows(i).Item("DataColumn22") = Val(ds.Tables(10).Rows(i).Item("DataColumn5") / 1.12).ToString("n2")
                                ds.Tables(10).Rows(i).Item("DataColumn23") = ds.Tables(10).Rows(i).Item("DataColumn22") - (ds.Tables(10).Rows(i).Item("DataColumn8") - ds.Tables(10).Rows(i).Item("DataColumn4"))
                            Else
                                ds.Tables(10).Rows(i).Item("DataColumn22") = "0.00"
                            End If
                            MyText = CType(objRpt.ReportDefinition.ReportObjects("Text96"), TextObject)
