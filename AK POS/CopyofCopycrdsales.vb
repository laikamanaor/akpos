...
Public Class CopyofCopycrdsales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AK_POS.CopyofCopycrdsales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopyofCopycrdsales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CopyofCopycrdsales = New CopyofCopycrdsales()
        rpt.Site = Me.Site
        Return rpt
    End Function
