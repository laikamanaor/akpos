...
Public Class crordernumber
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AK_POS.crordernumber.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_order_number() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcrordernumber
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crordernumber = New crordernumber()
        rpt.Site = Me.Site
        Return rpt
    End Function
