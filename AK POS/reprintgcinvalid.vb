...
Public Class reprintgcinvalid
    ...
    Public objRpt As New crreceiptnewgcinvalid
    ...
    Private Sub receiptprev_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If sngle = True Then
                ...
                If ds.Tables(11).Rows(0).Item("DataColumn12") < 1000000 Then
                    Dim temp As String = ""
                    Dim s As String = ds.Tables(11).Rows(0).Item("DataColumn12")
                    For vv As Integer = 1 To 6 - s.Length
                        temp = temp & "0"
                    Next
                    ds.Tables(11).Rows(0).Item("DataColumn12") = temp & s
                End If


                objRpt.SetDataSource(Me.ds.Tables(11))
                ...
                '// If a = vbYes Then
                'MsgBox(ds.Tables(11).Rows(0).Item(0))
    ...
    Public Sub singletr()
        Try
            ...
            If disc <> "" Then
                sqlquery = "SELECT tbltransaction.transnum,tbltransaction.cashier,tbltransaction.servicetype,tbltransaction.delcharge,tbltransaction.subtotal,tbltransaction.less,tbltransaction.vat,tbltransaction.amtdue,tbltransaction.tenderamt,tbltransaction.change,tbltransaction.vatsales,tbltransaction.transid,tbltransaction.gctotal,tblsenior.idno,tblsenior.name  FROM tbltransaction RIGHT OUTER JOIN tblsenior ON tbltransaction.transnum=tblsenior.transnum where tbltransaction.transnum='" & trnum & "' order by tbltransaction.transid DESC"
                connect()
                sql = procesSQL()
                Me.Cursor = Cursors.WaitCursor

                dscmd = New SqlDataAdapter(sql, conn)
                dscmd.Fill(ds.DataTable12)
                'MsgBox(ds.Tables(11).Rows.Count)
                disconnect()

            Else
                sqlquery = "SELECT tbltransaction.transnum,tbltransaction.cashier,tbltransaction.servicetype,tbltransaction.delcharge,tbltransaction.subtotal,tbltransaction.less,tbltransaction.vat,tbltransaction.amtdue,tbltransaction.tenderamt,tbltransaction.change,tbltransaction.vatsales,tbltransaction.transid,tbltransaction.gctotal FROM tbltransaction  where tbltransaction.transnum='" & trnum & "' order by tbltransaction.transid DESC"
                connect()
                sql = procesSQL()
                Me.Cursor = Cursors.WaitCursor
            ...
            If ds.Tables(11).Rows.Count > 0 Then
                If ds.Tables(11).Rows(0).Item("DataColumn6") = "0.00" Then
                ...
                For i = 0 To ds.Tables(0).Rows.Count - 1
                    ...
                    If dr.Read Then
                        If dr("disctype").ToString.Contains("Senior") Or dr("disctype").ToString.Contains("Pwd") Then
                            ds.Tables(0).Rows(i).Item("DataColumn16") = Val(ds.Tables(0).Rows(i).Item("DataColumn5") / 1.12).ToString("n2")
                        Else
                            ds.Tables(0).Rows(i).Item("DataColumn16") = "0.00"
                        End If
                    ...
                    'ds.Tables(0).Rows(0).Item("DataColumn16") = "0.00"
                    ds.Tables(0).Rows(i).Item("DataColumn18") = Val(ds.Tables(0).Rows(i).Item("DataColumn5")) - (Val(ds.Tables(0).Rows(i).Item("DataColumn8")) - Val(ds.Tables(0).Rows(i).Item("DataColumn4")))
                    ...
                    ds.Tables(0).Rows(i).Item("DataColumn19") = tempprice

                    ds.Tables(0).Rows(i).Item("DataColumn17") = Val(ds.Tables(0).Rows(i).Item("DataColumn18")) + Val(ds.Tables(0).Rows(i).Item("DataColumn19"))
            ...
            While dr.Read
                ...
                Else
                    ...
                    If ds.Tables(11).Rows.Count > 0 Then
                        ...
                        For i = 0 To ds.Tables(11).Rows.Count - 1
                            If ds.Tables(11).Rows(i).Item("DataColumn18") <> "0" Then
                                ds.Tables(11).Rows(i).Item("DataColumn11") = ds.Tables(11).Rows(i).Item("DataColumn11") & " -" & ds.Tables(11).Rows(i).Item("DataColumn18") & "% off"
                            End If
                        Next
                    End If
                End If
