...
Public Class cr_invtransaction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AK_POS.cr_invtransaction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_invtransaction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_invtransaction = New cr_invtransaction()
        rpt.Site = Me.Site
        Return rpt
    End Function
