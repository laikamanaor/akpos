...
Partial Class pendingsap2
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbtype.Items.AddRange(New Object() {"---", "Received Item", "Transfer Item", "Pull Out", "Adjustment Item", "AR Charge", "AR Sales", "AR Cash", "Conversion In", "Conversion Out", "Cash Out For Deposit"})
