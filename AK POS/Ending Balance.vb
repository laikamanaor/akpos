...
Public Class Ending_Balance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AK_POS.Ending Balance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEnding_Balance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ending_Balance = New Ending_Balance()
        rpt.Site = Me.Site
        Return rpt
    End Function
