...
Public Class c_advancepayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AK_POS.c_advancepayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedc_advancepayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As c_advancepayment = New c_advancepayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
